...
#define stat(s) // cerr <<"[POINTCLOUD Parser] "<< s << endl;
...
namespace CGL {
  ...
  XMLElement* PointCloudParser::e_scenes;       // POINTCLOUD library: scenes
  XMLElement* PointCloudParser::e_cameras;      // POINTCLOUD library: cameras
  XMLElement* PointCloudParser::e_lights;       // POINTCLOUD library: lights
  XMLElement* PointCloudParser::e_geometries;   // POINTCLOUD library: geometries
  XMLElement* PointCloudParser::e_materials;    // POINTCLOUD library: materials
  XMLElement* PointCloudParser::e_effects;      // POINTCLOUD library: effects
  ...
  void PointCloudParser::parseScene( XMLElement* xml, Scene& scene ) {
  ...
  void PointCloudParser::parseNode( XMLElement* xml, Node& node ) {
    ...
    if ( e_mat ) { // given as matrix
      ...
      Matrix4x4 mat; // POINTCLOUD uses row-majored representation
  ...
  // void PointCloudParser::parseCamera( XMLElement* xml, Camera& camera ) {
  ...
  void PointCloudParser::parseLight( XMLElement* xml, Light& light ) {
  ...
  void PointCloudParser::parsePolymesh( XMLElement* xml, Polymesh& polymesh ) {
  ...
  void PointCloudParser::parseMaterial ( XMLElement* xml, Material& material ) {
