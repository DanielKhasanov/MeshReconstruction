...
namespace CGL {
  ...
  void MeshEdit::update_camera()
  {
    ...
    gluLookAt(   cx,   cy,   cz,// camera location.
      ...
      // float t_rand = rand();
      // glUniform1f(glGetUniformLocation(shaderProgID, "t_rand"), t_rand);
              ...
              */
              ...
              void MeshEdit::dragPosition(float screen_x_offset, float screen_y_offset,
                Vector3D & position)
                {
                  ...
                  void MeshEdit::ballPivotSelectedMesh()
                  {
                    HalfedgeMesh* mesh;
                    ...
                    floating_vertices = resampler.ball_pivot(*mesh, current_faces);
